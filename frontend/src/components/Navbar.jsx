      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex flex-wrap justify-between items-center">
          <Link to="/" className="flex items-center space-x-1 text-yellow-600">
            ...
            <span className="text-1xl">Jewelry</span>
          </Link>
          ...
          <nav className="flex flex-wrap items-center gap-4">
            ...
            {user && (
              ...
              >
                <ShoppingCart
                  className="inline-block mr-1 group-hover:text-yellow-500"
                  size={20}
                />
                <span className="hidden sm:inline">Cart</span>
                {cart.length > 0 && (
                  <span className="absolute -top-2 -left-2 bg-yellow-600 text-white rounded-full px-2 py-0.5 text-xs group-hover:bg-yellow-500 transition duration-300 ease-in-out">
                    {cart.length}
                  </span>
                )}
              </Link>
            ...
            {user ? (
              ...
              <>
                <Link
                  to={"/signup"}
                  className="bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out"
                >
